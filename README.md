...
| **Database** | MySQL & Firebase | Relational data management and real-time event synchronization. |
| **Frontend Framework** | Vue.js | Dynamic, reactive single-page application (SPA) components. |
...
| **Coordinator** | Event coordination, resource allocation, and timeline management. | Event Coordinators |
...
1. Clone the repository:
   ...
   ```
2. Configure your local PHP environment (e.g., XAMPP, Laragon) and Node.js environment.
3. Import the MySQL database schema provided in the project files.
